    ...
    Route::group(['middleware' => 'auth'], function () {
        ...
        Route::prefix('b')->group(function(){
            ...
            Route::prefix('cooperation')->group(function(){
                ...
                Route::get('{id}/perjanjian_kerjasama', [App\Http\Controllers\v1\CooperationController::class, 'cooperation_pdf_perjanjian'])->name('b.cooperation_pdf_perjanjian')->middleware('verified');
