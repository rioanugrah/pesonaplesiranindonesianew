...
@endsection
@section('canonical')
    {{ route('frontend.kebijakan_privasi') }}
@endsection
@section('url')
    {{ route('frontend.kebijakan_privasi') }}
@endsection
...
<section class="space">
    <div class="container">
        ...
        <ul>
            ...
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                    or
                    &quot;Our&quot; in this Agreement) refers to CV Pesona Plesiran Indonesia, Jl. Raya Tlogowaru No.3,
                    Tlogowaru, Kec. Kedungkandang, Malang, Jawa Timur.</p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Website</strong> refers to Pesona Plesiran Indonesia, accessible from <a
                        href="https://plesiranindonesia.com" rel="external nofollow noopener"
                        target="_blank">https://plesiranindonesia.com</a></p>
            </li>
            <li>
        ...
        <ul>
            <li>By email: contact@plesiranindonesia.com</li>
        </ul>
    </div>
</section>
@endsection
