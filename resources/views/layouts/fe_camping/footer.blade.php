                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="single-info-item mb-40">
                        ...
                        <div class="info">
                            ...
                            <p><a href="tel:085867224494">0858-6722-4494</a></p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="footer-text">
                        <p>Copyright @ {{ date('Y') }} <span style="color: #F7921E;">Camping Adventure</span>, All Right Reserved Powered By <span style="color: #F7921E;">Pesona Plesiran Indonesia</span></p>
                    </div>
                </div>
                {{-- <div class="col-lg-6">
