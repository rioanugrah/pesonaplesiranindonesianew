    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="left-menu list-unstyled" id="side-menu">
                <li>
                    <a href="{{ route('it.dashboard') }}" class="">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="ui-colors.html"><i class="mdi mdi-checkbox-blank-circle align-middle"></i> Colors</a></li>
                        ...
                        <li><a href="ui-modals.html"><i class="mdi mdi-checkbox-blank-circle align-middle"></i> Modals</a></li>
                        <li><a href="ui-nav.html"><i class="mdi mdi-checkbox-blank-circle align-middle"></i> Navigation</a></li>
                        ...
                        <li><a href="ui-popover.html"><i class="mdi mdi-checkbox-blank-circle align-middle"></i> Popover</a></li>
                        <li><a href="ui-progress-bars.html"><i class="mdi mdi-checkbox-blank-circle align-middle"></i> Progress bar</a></li>
                        <li><a href="ui-spinner.html"><i class="mdi mdi-checkbox-blank-circle align-middle"></i> Spinners</a></li>
                        <li><a href="ui-tabs.html"><i class="mdi mdi-checkbox-blank-circle align-middle"></i> Tabs</a></li>
                        <li><a href="ui-tables.html"><i class="mdi mdi-checkbox-blank-circle align-middle"></i> Tables</a></li>
                        <li><a href="ui-tooltip.html"><i class="mdi mdi-checkbox-blank-circle align-middle"></i> Tooltips</a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="icons-materialdesign.html"><i class="mdi mdi-checkbox-blank-circle align-middle"></i> Material Design</a></li>
                        <li><a href="icons-fontawesome.html"><i class="mdi mdi-checkbox-blank-circle align-middle"></i> Font awesome 5</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="charts-apex-timeline.html"><i class="mdi mdi-checkbox-blank-circle"></i> Timeline</a></li>
                        <li><a href="charts-apex-candle.html"><i class="mdi mdi-checkbox-blank-circle"></i> Candlestick</a></li>
                        <li><a href="charts-apex-box&whisker.html"><i class="mdi mdi-checkbox-blank-circle"></i> Box & Whisker</a></li>
                        ...
                        <li><a href="charts-apex-polar.html"><i class="mdi mdi-checkbox-blank-circle"></i> Polar Area</a></li>
                        <li><a href="charts-apex-radial.html"><i class="mdi mdi-checkbox-blank-circle"></i> Radial/Circle</a></li>
                        <li><a href="charts-apex-bubble.html"><i class="mdi mdi-checkbox-blank-circle"></i> Bubble</a></li>
                        <li><a href="charts-apex-scatter.html"><i class="mdi mdi-checkbox-blank-circle"></i> Scatter</a></li>
                        <li><a href="charts-apex-heatmap.html"><i class="mdi mdi-checkbox-blank-circle"></i> Heatmap</a></li>
                        <li><a href="charts-apex-treemap.html"><i class="mdi mdi-checkbox-blank-circle"></i> Treemap</a></li>
                    </ul>
                </li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                ...
                                <li><a href="datatable-scrollable.html"><i class="mdi mdi-circle-outline"></i> Scrollable</a></li>
                                <li><a href="datatable-pagination.html"><i class="mdi mdi-circle-outline"></i> Pagination</a></li>
                                <li><a href="datatable-page-length.html"><i class="mdi mdi-circle-outline"></i> Length menu</a></li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                ...
                                <li><a href="datatable-adv-col-visibility.html"><i class="mdi mdi-circle-outline"></i> Column visibility</a></li>
                                <li><a href="datatable-adv-footer-callback.html"><i class="mdi mdi-circle-outline"></i> Footer callback</a></li>
                                <li><a href="datatable-adv-multi-control.html"><i class="mdi mdi-circle-outline"></i> Multiple controls</a></li>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="datatable-ext-autofill.html"><i class="mdi mdi-circle-outline"></i> Auto fill</a></li>
                                ...
                                <li><a href="datatable-ext-keytable.html"><i class="mdi mdi-circle-outline"></i> Key table</a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="form-bs-maxlength.html"><i class="mdi mdi-checkbox-blank-circle align-middle"></i> Bootstrap maxlength</a></li>
                        ...
                        <li><a href="form-datetimepicker.html"><i class="mdi mdi-checkbox-blank-circle align-middle"></i> Date time picker</a></li>
                        <li><a href="form-rangepicker.html"><i class="mdi mdi-checkbox-blank-circle align-middle"></i> Range picker</a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="auth-login.html"><i class="mdi mdi-checkbox-blank-circle align-middle"></i> Login</a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="pages-404.html"><i class="mdi mdi-checkbox-blank-circle align-middle"></i> Error 404</a></li>
                        <li><a href="pages-500.html"><i class="mdi mdi-checkbox-blank-circle align-middle"></i> Error 500</a></li>
                    </ul>
                </li>
