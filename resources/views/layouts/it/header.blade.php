                ...
                <div class="dropdown d-inline-block">
                    ...
                    <div class="dropdown-menu dropdown-menu-wide dropdown-menu-end dropdown-menu-animated overflow-hidden py-0">
                        <div class="card border-0">
                            ...
                            <div class="card-footer card-footer-bordered rounded-0"><a href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="btn btn-label-danger">Sign out</a></div>
                            <form id="logout-form" action="{{ route('it.logout') }}" method="POST" style="display: none;">
                                @csrf
                            </form>
                        </div>
                    </div>
