...
<body>
    <div id="layout-wrapper">
        @include('layouts.it.header')
        @include('layouts.it.sidebar')
    ...
    <script src="{{ asset('it') }}/assets/libs/apexcharts/apexcharts.min.js"></script>

    <script src="{{ asset('it') }}/assets/js/pages/dashboard.init.js"></script>
