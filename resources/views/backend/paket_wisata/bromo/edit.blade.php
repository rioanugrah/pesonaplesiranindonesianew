            ...
            <div class="card">
                <form id="upload-form" method="post" enctype="multipart/form-data">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <label>Title</label>
                            <input type="text" name="title" class="form-control" value="{{ $bromo->title }}" placeholder="Title" id="">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="meeting_point" placeholder="Meeting Point" value="{{ $bromo->meeting_point }}" class="form-control"
                                id="">
                        </div>
                        <div class="mb-3">
                            ...
                            <select name="category_trip" class="form-control" id="">
                                ...
                                <option value="Private" {{ $bromo->category_trip == 'Private' ? 'selected' : null }}>Private</option>
                                <option value="Publik" {{ $bromo->category_trip == 'Publik' ? 'selected' : null }}>Open Trip</option>
                            </select>
                        </div>
                        <div class="mb-3">
...
@section('script')
    ...
    <script>
        $('#upload-form').submit(function(e) {
            ...
            $.ajax({
                type:'POST',
                url: "{{ route('bromo.b_bromo_update',['id' => $bromo->id]) }}",
                data: formData,
                contentType: false,
                processData: false,
                beforeSend: () => {
