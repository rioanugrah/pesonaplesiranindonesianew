...
@section('content')
    @include('backend.campings.category.modalBuat')
    @include('backend.campings.category.modalEdit')
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="btn-group mt-2 mb-2 pull-right">
                        <button onclick="buat()" class="btn btn-primary"><i class="fas fa-plus"></i> Buat Baru</button>
...
@section('script')
    ...
    <script>
        ...
        function edit(id) {
            $.ajax({
                type: 'GET',
                url: "{{ url('b/camping/category/') }}" + '/' + id,
                contentType: false,
                processData: false,
                success: (result) => {
                    if (result.success != false) {
                        $('#edit_id').val(result.data.id);
                        $('#edit_nama_kategori').val(result.data.nama_kategori);
        ...
        function hapus(id) {
            $.ajax({
                type: 'DELETE',
                url: "{{ url('b/camping/category/') }}" + '/' + id + '/delete',
        ...
        $('#upload-form').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('b.camping_categori_simpan') }}",
                data: formData,
                contentType: false,
                processData: false,
                success: (result) => {
        ...
        $('#edit-form').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('b.camping_categori_update') }}",
                data: formData,
                contentType: false,
                processData: false,
                success: (result) => {
