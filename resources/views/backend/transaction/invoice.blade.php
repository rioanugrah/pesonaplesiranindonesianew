            ...
            <div class="card-body">
                <div class="invoice-title">
                    <h4 class="float-end font-size-16">Invoice #{{ $transaction->transaction_code }}
                        @switch($transaction->status)
                            @case('Unpaid')
                                <span class="badge bg-warning font-size-12 ms-2">Unpaid</span></h4>
                                @break
                            @case('Paid')
                ...
                <div class="py-2">
                    ...
                    <div class="d-print-none mt-4">
                        <div class="float-end">
                            <a href="javascript:void(0)" onclick="window.location.href='{{ route('b.transaction') }}'" class="btn btn-secondary waves-effect waves-light me-1"><i
